...
const PROJECTS = [
  ...
  },
  {
    ...
    tags: ["React", "Laravel", "MySQL", "Stripe", "TailwindCSS", "AI Chatbot"],
    github: "https://github.com/earth-lion/smart-student-portal",
    link: "https://earth-lion.github.io/smart-student-portal/",
    category: "fullstack",
...
const FILTERS = {
  ...
  ar: [
    { k: "all", l: "الكل" },
    { k: "fullstack", l: "فول ستاك" },
    { k: "frontend", l: "فرونت إند" },
  ],
};
    ...
    >
      <div className="container">
        <div ref={ref} style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          {/* Filter tabs */}
          <div
            className={`reveal${visible ? " visible" : ""} d1 filter-row`}
            style={{
              display: "flex",
              justifyContent: "center",
              gap: "8px",
        ...
        <div style={{ direction: isRTL ? "rtl" : "ltr" }} className="grid-3">
          {filtered.map((p, i) => (
            <div
              key={p.id}
              className={`reveal${visible ? " visible" : ""} d${(i % 4) + 1}`}
            >
              <ProjectCard
                project={p}
                lang={lang}
